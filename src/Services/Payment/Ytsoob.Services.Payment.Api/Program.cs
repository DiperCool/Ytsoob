...
using Ytsoob.Services.Payment.Api.Extensions.ApplicationBuilderExtensions;
using Microsoft.AspNetCore.Mvc.ApplicationModels;
using Spectre.Console;

AnsiConsole.Write(new FigletText("Payment Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255))));
