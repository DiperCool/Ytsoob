...
using Ytsoob.Services.Identity.Identity.Features.GettingClaims.v1;
using Ytsoob.Services.Identity.Identity.Features.Login.v1;
using Ytsoob.Services.Identity.Identity.Features.Logout.v1;
using Ytsoob.Services.Identity.Identity.Features.RefreshingToken.v1;
using Ytsoob.Services.Identity.Identity.Features.RevokingAccessToken.v1;
using Ytsoob.Services.Identity.Identity.Features.RevokingRefreshToken.v1;
using Ytsoob.Services.Identity.Identity.Features.SendingEmailVerificationCode.v1;
using Ytsoob.Services.Identity.Identity.Features.VerifyingEmail.v1;
using Ytsoob.Services.Identity.Shared.Extensions.WebApplicationBuilderExtensions;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Ytsoob.Services.Identity.Identity.Data;
using Ytsoob.Services.Identity.Shared;

namespace Ytsoob.Services.Identity.Identity;
