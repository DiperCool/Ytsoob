...
using Ytsoob.Services.Ytsoobers.Api.Extensions.ApplicationBuilderExtensions;

AnsiConsole.Write(
    new FigletText("Ytsoobers Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255)))
);
