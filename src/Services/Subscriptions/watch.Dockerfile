...
COPY ./src/Services/Subscriptions/Directory.Build.props ./Services/Subscriptions/
...
COPY ./src/Services/Subscriptions/Ytsoob.Services.Subscriptions/ ./Services/Subscriptions/Ytsoob.Services.Subscriptions/
COPY ./src/Services/Shared/ ./Services/Shared/

WORKDIR /src/Services/Subscriptions/Ytsoob.Services.Subscriptions.Api/

RUN dotnet watch run Ytsoob.Services.Subscriptions.Api.csproj --launch-profile Subscriptions.Api.LiveRecompilation
