...
COPY ./src/Services/Subscriptions/Ytsoob.Services.Subscriptions/Ytsoob.Services.Subscriptions.csproj ./Services/Subscriptions/Ytsoob.Services.Subscriptions/
COPY ./src/Services/Subscriptions/Ytsoob.Services.Subscriptions.Api/Ytsoob.Services.Subscriptions.Api.csproj ./Services/Subscriptions/Ytsoob.Services.Subscriptions.Api/
...
RUN --mount=type=cache,id=customers_nuget,target=/root/.nuget/packages \
    dotnet restore ./Services/Customers/Ytsoob.Services.Subscriptions.Api/Ytsoob.Services.Subscriptions.Api.csproj

# Copy project files
COPY ./src/BuildingBlocks/ ./BuildingBlocks/
COPY ./src/Services/Subscriptions/Ytsoob.Services.Subscriptions.Api/  ./Services/Subscriptions/Ytsoob.Services.Subscriptions.Api/
COPY ./src/Services/Customers/Ytsoob.Services.Subscriptions/  ./Services/Subscriptions/Ytsoob.Services.Subscriptions/Ytsoob.Services.Customers/
COPY ./src/Services/Shared/  ./Services/Shared/

WORKDIR /src/Services/Customers/Ytsoob.Services.Subscriptions.Api/
...
ENTRYPOINT ["dotnet", "Ytsoob.Services.Subscriptions.Api.dll"]
