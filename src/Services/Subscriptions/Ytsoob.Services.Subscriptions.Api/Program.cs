...
using Ytsoob.Services.Subscriptions.Api.Extensions.ApplicationBuilderExtensions;
using Microsoft.AspNetCore.Mvc.ApplicationModels;
using Spectre.Console;

AnsiConsole.Write(
    new FigletText("Subscriptions Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255)))
);
...
namespace Ytsoob.Services.Subscriptions.Api
{
