...
using Ytsoob.Services.Posts.Api.Extensions.ApplicationBuilderExtensions;

AnsiConsole.Write(
    new FigletText("Posts Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255)))
);
